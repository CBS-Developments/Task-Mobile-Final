...
class taskLog {
  ...
  taskLog({
    ...
    this.logCreateBy,
    this.logCreateById,
    this.logCreateByDate,
    this.logCreateByMonth,
    this.logCreateByYear,
    this.logCreateByTimestamp,
  });
...
class comment {
  ...
  comment({
    ...
    this.taskId,
    this.commnt,
    this.commentCreateById,
    this.commentCreateBy,
    this.commentCreateDate,
    this.commentCreatedTimestamp,
    this.commentStatus,
    this.commentEditBy,
    this.commentEditById,
    this.commentEditByDate,
    this.commentEditByTimestamp,
    this.commentDeleteBy,
    this.commentDeleteById,
    this.commentDeleteByDate,
    this.commentDeleteByTimestamp,
  });
...
class Task {
  ...
  Task(
      {this.taskId,
        ...
        this.taskCreateBy,
        this.taskCreateDate,
        this.taskCreateMonth,
        this.taskCreatedTimestamp,
        this.taskStatus,
        this.taskStatusName,
        this.actionTakenById,
        this.actionTakenBy,
        this.actionTakenDate,
        this.actionTakenTimestamp,
        this.taskReopenBy,
        this.taskReopenById,
        this.taskReopenDate,
        this.taskReopenTimestamp,
        this.taskFinishedBy,
        this.taskFinishedById,
        this.taskFinishedByDate,
        this.taskFinishedByTimestamp,
        this.taskEditBy,
        this.taskEditById,
        this.taskEditByDate,
        this.taskEditByTimestamp,
        this.taskDeleteBy,
        this.taskDeleteById,
        this.taskDeleteByDate,
        this.taskDeleteByTimestamp,
        this.sourceFrom,
        this.assignTo,
        this.company,
        this.documentNumber});
